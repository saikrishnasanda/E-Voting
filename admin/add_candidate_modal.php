        ...
        <div class="modal-content">
				...
				<form method = "post" enctype = "multipart/form-data">	
					<div class="form-group">
						...
						<select class = "form-control" name = "position">
								...
								<option>Vice Manager</option>
								<option>Accountant</option>
								<option>Incharge</option>
								<option>Warden</option>
								<option>Mess Head</option>
								<!--<option>Work Leader</option>
								<option>PIO</option>
			...
			<?php 
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO candidate(position,firstname,lastname,gender,img)values('$position','$firstname','$lastname','$gender','$location')")or die(mysql_error());
				}						
			?>					
        </div>
